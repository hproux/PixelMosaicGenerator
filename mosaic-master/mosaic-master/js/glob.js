...
Glob = function () {}
Glob.hideWebsiteInfo = true; // if true, website info in PDF file (https://bse/mosaic) will be hidden
...
Glob.totalGradSteps = 3; // number of steps for grad method selection (default: 3)
...
Glob.initialCubeDimen = 1; // 1 for pixart, 3 for 3x3 cubes (default)
Glob.initialCubeWidth = 20;
Glob.initialCubeHeight = 30;
Glob.maxCubesSize = 300; // max is 100x100 (default)
